...
def discover_faiss_dbs(db_path: str) -> dict[str, Any]:
...
def discover_sqlite_vec_dbs(db_path: str) -> dict[str, Any]:
...
def discover_vector_dbs(provider_type: str, db_path: str) -> dict[str, Any]:
