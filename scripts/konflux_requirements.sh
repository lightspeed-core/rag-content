...
# Packages from packages.redhat.com go to requirements.wheel.txt
...
RHOAI_INDEX_URL="https://packages.redhat.com/api/pypi/public-rhai/rhoai/3.2/cpu-ubi9/simple/"
