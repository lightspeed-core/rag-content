...
CPU_PULP_33="https://packages.redhat.com/api/pulp-content/public-rhai/rhoai/3.3/cpu-ubi9"
{
	printf '%s\n' "# Autogenerated by konflux_requirements.sh — linux/x86_64 arch-specific wheels (Hermeto)."
	printf '%s\n' "torch @ ${CPU_PULP_33}/torch-2.9.1-4-cp312-cp312-linux_x86_64.whl \\"
	printf '%s\n' "    --hash=sha256:e42ab849b64444059f5eda352d61c9c3a078f30797e48e2972857182c9a00cf8"
	printf '%s\n' "torchvision @ ${CPU_PULP_33}/torchvision-0.24.1-2-cp312-cp312-linux_x86_64.whl \\"
	printf '%s\n' "    --hash=sha256:e8fc51b8b29433d2dd51d46da204c1d613c65d788f65559cdcb8a3585092a7e7"
	printf '%s\n' "triton @ ${CPU_PULP_33}/triton-3.5.1-2-cp312-cp312-linux_x86_64.whl \\"
	printf '%s\n' "    --hash=sha256:7b1a1b9ab53eafe7a65ae25861ac7df5541ea706b3baebe2306580127825e222"
} > "$WHEEL_HASH_CPU_X86"
{
	printf '%s\n' "# Autogenerated by konflux_requirements.sh — linux/aarch64 arch-specific wheels (Hermeto)."
	printf '%s\n' "torch @ ${CPU_PULP_33}/torch-2.9.1-4-cp312-cp312-linux_aarch64.whl \\"
	printf '%s\n' "    --hash=sha256:28171ed367139717fe7b8d6918c86d0fe328a7faa5704f5951283ae3b01796a1"
	printf '%s\n' "torchvision @ ${CPU_PULP_33}/torchvision-0.24.1-2-cp312-cp312-linux_aarch64.whl \\"
	printf '%s\n' "    --hash=sha256:721770c61c49feac3cbfb522872feb6f6f61e1f6dcee8fcd9a638cc49e7959ef"
	printf '%s\n' "triton @ ${CPU_PULP_33}/triton-3.5.1-2-cp312-cp312-linux_aarch64.whl \\"
	printf '%s\n' "    --hash=sha256:f45cd8a990cde562e64b6ef00969dc3751a49e90651216e7f7b44ba997c9e19d"
