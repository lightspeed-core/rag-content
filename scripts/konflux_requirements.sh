...
CPU_PULP_33="https://packages.redhat.com/api/pulp-content/public-rhai/rhoai/3.3/cpu-ubi9"
{
	...
	printf '%s\n' "triton @ ${CPU_PULP_33}/triton-3.5.0-3-cp312-cp312-linux_x86_64.whl \\"
	printf '%s\n' "    --hash=sha256:a916a1758674bbc35545f3aed9c1e83ed581b59a277cfffca1926c6f5f567a96"
} > "$WHEEL_HASH_CPU_X86"
{
	...
	printf '%s\n' "triton @ ${CPU_PULP_33}/triton-3.5.0-3-cp312-cp312-linux_aarch64.whl \\"
	printf '%s\n' "    --hash=sha256:a46eaadd18e726ff38f9cfb53c4e641dfe937741394cdf45e2981858200fae1d"
