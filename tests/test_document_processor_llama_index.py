...
class TestDocumentProcessorLlamaIndex(utils.TestCase):
    ...
    def test__save_metadata(self, mock_file, mock_dumps):
        self.doc_processor.db._save_metadata("fake-index",
                                             "/fake/path",
    ...
    def test_process(self, mock_dir_reader):
        ...
        mock_filter = self.patch_object(self.doc_processor.db.__class__,
    ...
    def test_process_drop_unreachable(self, mock_dir_reader):
        ...
        mock_filter = self.patch_object(self.doc_processor.db,
                                        "_filter_out_invalid_nodes",
                                        return_value=fake_good_nodes)

        self.doc_processor.process(Path("/fake/path/docs"),
                                   fake_metadata, unreachable_action="drop")
    ...
    def test_save(self):
        mock_index = self.patch_object(self.doc_processor.db,
                                       "_save_index")
        mock_md = self.patch_object(self.doc_processor.db,
                                    "_save_metadata")
